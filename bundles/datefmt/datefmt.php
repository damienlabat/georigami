...
{
  public function __construct($message) { return parent::__construct('DateFmt: '.$message); }
}
  ...
  class EDateLastPCRE extends DateError
  {
    ...
    public static function ThrowIfPcreFailed()
    {
...
class DateFmt
{
  public static $selfTests;  // debug; use RunSelfTests(); is populated at the end of this file.
  public static $languages;  // use LoadLangauge(); is populated at the end of this file.
  ...
  public static $agoChars = array('s' => 60, 'i' => 60, 'h' => 24, 'w' => array(7, 4), 'd' => 30,
                           'o' => 12, 'y' => false);

  public $date, $now;
  public $strings;

  public static function Format($str, $date = null, $language = null)
  {
  ...
  public function __construct($date = null)
  {
    ...
    public function LoadLanguage($iso2OrArray)
    {
  ...
  public function FmtStr($name, $args)
  {
    return strtr($this->strings[$name], $args);
  }

  public function FmtNum($number, $langName)
  {
    ...
    public static function FmtNumUsing($stem, $inflections, $numberRolls, $number)
    {
      $inflection = '';
  ...
  public static function FixFloat($float)
  {
  ...
  public function FormatNormal($format, $wordForm = '')
  {
    $regExp = '~
                d(\#\#?) m(y?)
              | (h)(\#\#?) m(s?)
    ...
    public function NormalFormatter($match)
    {
  ...
  public function amPM() { return $this->strings[ date('A', $this->date) ]; }

  public function FormatDate($dayLeadZero = false, $withYear = true)
  {
    $fmt = array();
    ...
    public function FormatTime($hoursLeadZero = false, $withSeconds = false)
    {
      $fmt = array('%' => '');
  ...
  public function FormatAGO($format, $options = array())
  {
  ...
  public function FormatExactAGO($ranges, $options = array())
  {
    $chars = $ranges;
    ...
    public function FormatExactAgoLimitedTo($chars, $distance, $options)
    {
  ...
  // AGO[smh]
  // $options: isShort, wordForm, noAgoWord, ifFAR, ifRange, ifFormat.
  public function FormatFuzzyAGO($format, $options = array())
  {
    $distance = $this->now - $this->date;
    $isInFuture = $distance < 0;
    $distance = abs($distance);
    ...
    public function AgoStr($char, $distance, $options)
    {
    ...
    public function NormAgoFormat($format, $distance, &$useNearDays)
    {
    ...
    public function FormatIF($chars, $distance, $options)
    {
      extract($options, EXTR_SKIP);
    ...
    public function FindNearestLimitedTo($ranges, $distance)
    {
      $nearChar = null;
...
DateFmt::$languages = array(
  ...
  'fr' => array(
    ...
    'float delim' => '.', 'at-time' => ' à', 'AM' => 'AM', 'PM' => 'PM',
    ...
    'full months'   => array('Janvier', 'Février', 'Mars', 'Avril', 'Mai',
                             'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre',
                             'Novembre', 'Décembre'),
    'short months'  => array('Janvier', 'Février', 'Mars', 'Avril', 'Mai',
                             'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre',
                             'Novembre', 'Décembre'),

    'full days'     => array('Dimanche', 'Lundi', 'Mardi', 'Mercredi', 'Jeudi',
                             'Vendredi', 'Samedi'),
    'short days'    => array('Dimanche', 'Lundi', 'Mardi', 'Mercredi', 'Jeudi',
                             'Vendredi', 'Samedi'),
