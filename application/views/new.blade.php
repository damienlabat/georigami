                        ...
                        <div class="row">
                            ...
                            <div class="span5">
                                ...
                                <div class='control-group'>
                                    ...
                                    <div class="controls"><input type="text" id="input-horizontal-samples" class="uneditable-input" readonly='readonly'> (max 500)</div>
                                </div>
                                <div class='control-group livechange'>
                                ...
                                <div class='control-group'>
                                    ...
                                    <div class="controls"><input type="text" id="input-vertical-samples" class="uneditable-input" readonly='readonly'> (max 500)</div>
                                </div>
                            </div>
                        </div>
